  ...
  const feedPosts = [
    {
      ...
      content: {
        ...
        description: "It's been an exciting journey, and we couldn't have done it without the support of our amazing team and early testers. Your feedback means the world—feel free to explore and let us know your thoughts.",
    ...
    },
    {
      ...
      content: {
        ...
        description: "Our team came up with some incredible ideas for the next quarter. Innovation happens when great minds come together. Excited to see these concepts come to life!",
    ...
    },
    {
      ...
      content: {
        ...
        description: "Today's presentation went exceptionally well. The client loved our new approach and we're moving forward with the project. These moments remind me why I love what I do.",
    ...
    },
    {
      ...
      content: {
        ...
        description: "Just completed an advanced course on AI and machine learning. The future is incredibly exciting, and I can't wait to apply these new skills to our upcoming projects.",
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin pr-2">
            ...
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center">
                <span className="font-semibold text-sm sm:text-base">Cody Fisher</span>
                <span className="text-teal-400 text-xs sm:text-sm sm:ml-2">( 3 credits remain )</span>
              </div>
            </div>
            ...
            <div className="bg-[#232323] rounded-2xl p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <button className="flex items-center justify-center gap-2 bg-[#323232] hover:bg-gray-600 px-3 sm:px-4 py-2.5 sm:py-2 rounded-lg transition-colors text-sm sm:text-base">
                  ...
                  <button className="bg-gradient-to-r from-[#3AADB2] to-[#0D777C] hover:bg-teal-600 px-4 sm:px-6 py-2.5 sm:py-2 rounded-lg font-medium transition-colors text-sm sm:text-base">
                    Post
                  </button>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <button className="flex items-center gap-2 bg-[#323232] p-3 rounded-2xl text-gray-400 hover:text-teal-400 transition-colors text-sm sm:text-base">
              ...
              <div key={post.id} className="bg-[#232323] rounded-2xl p-4 sm:p-6">
                <div className="flex items-center gap-3 pb-4 border-b border-[#373737]">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
                    ...
                    <span className="text-gray-400 text-xs sm:text-sm">{post.author.timeAgo}</span>
                  </div>
                </div>
                ...
                <div className="py-3 sm:py-4">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {post.content.hashtags.map((hashtag, index) => (
                      <span key={index} className="text-teal-400 text-xs sm:text-sm">{hashtag}</span>
                    ))}
                  </div>
                ...
                <div className="flex items-center justify-between border-t border-gray-700 pt-4">
                  <div className="flex items-center gap-3 sm:gap-6">
                    <button className="flex items-center gap-1 sm:gap-2 text-gray-400 hover:text-red-400 transition-colors">
                      ...
                      <span className="text-sm sm:text-base">{post.engagement.likes}</span>
                    </button>
                    <button className="flex items-center gap-1 sm:gap-2 text-gray-400 hover:text-teal-400 transition-colors">
                      <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5" />
                      <span className="text-sm sm:text-base">{post.engagement.comments}</span>
                    </button>
                ...
                <div className="mt-4 pt-4 border-t border-gray-700">
                  <div className="flex flex-col sm:flex-row gap-3 bg-[#232323] p-2 rounded-2xl border border-[#414141]">
                    ...
                    />
                    <button className="bg-gradient-to-r from-[#3AADB2] to-[#0D777C] hover:bg-teal-600 px-4 sm:px-6 py-3 rounded-lg font-medium transition-colors text-sm sm:text-base self-end sm:self-auto">
                      Comment
                    </button>
                  </div>
                </div>
          ...
          <div className="hidden xl:block w-80 flex-shrink-0">
            ...
            <div className="bg-[#2A2A2A] border border-[#414141] rounded-2xl relative mx-auto max-w-sm xl:max-w-none">
              ...
              <div className="h-32 sm:h-36 xl:h-40 bg-gradient-to-br from-[#0D4D4F] via-[#1A5F5F] to-[#0F3A3C] relative overflow-hidden rounded-t-2xl">
                ...
                <img src={neuralImg} alt="" className="w-full h-full object-cover" />
              </div>
              
              {/* Profile image positioned absolute - outside overflow container */}
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-50" style={{top: '80px'}}>
              ...
              <div className="pt-12 sm:pt-14 xl:pt-16 px-4 sm:px-6 pb-4 sm:pb-6 relative z-10">
                ...
                <div className="text-center mb-1">
                  <div className="flex items-center justify-center gap-2">
                    <h2 className="text-lg sm:text-xl font-bold text-white">Cody Fisher</h2>
                    <Edit className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 cursor-pointer hover:text-[#00C2C7]" />
                  </div>
                  <p className="text-gray-400 text-xs sm:text-sm">@codyfisher (Free)</p>
                </div>
                ...
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <div className="flex justify-between text-xs sm:text-sm mb-3 sm:mb-4">
                    <span className="text-gray-400">Credit used: <span className="text-white font-medium">1250</span></span>
                    <span className="text-gray-400">Credit Remain: <span className="text-white font-medium">245</span></span>
                  </div>

                  {/* Action buttons */}
                  <div className="flex gap-2 sm:gap-3">
                    <button className="flex-1 bg-[#3A3A3A] hover:bg-[#4A4A4A] py-2 sm:py-2.5 px-2 sm:px-4 rounded-lg text-xs sm:text-sm font-medium transition-colors flex items-center justify-center gap-1 sm:gap-2">
                      <span>Watch Ads</span>
                      <span className="text-sm sm:text-lg"><MdLiveTv /></span>
                    </button>
                    <button className="flex-1 bg-gradient-to-r from-[#3AADB2] to-[#0D777C] hover:bg-[#00A8AD] py-2 sm:py-2.5 px-2 sm:px-4 rounded-lg text-xs sm:text-sm font-medium text-white transition-colors">
                      Go Premium
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
                    ...
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <span className="text-gray-300 leading-relaxed">6391 Elgin St. Celina, Delaware 10299</span>
                    </div>
                    <div className="flex items-start gap-2 sm:gap-3">
                      <Briefcase className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-300 leading-relaxed">Social Media Manager at SiPT</span>
                    </div>
                  </div>

                  {/* Social links */}
                  <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row sm:items-center gap-2 border-gray-600">
                    <p className="text-xs sm:text-sm text-gray-400">Follow us:</p>
                    <div className="flex gap-2 sm:gap-3">
